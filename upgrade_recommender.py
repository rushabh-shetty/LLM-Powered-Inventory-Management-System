...
CATEGORIES = [
    ...
    {"name": "Environmental Parameters", "desc": "Thermal and hardware health conjure"},
...
def main():
    ...
    # Post-report Q&A
    post_report_qa(api_key, analysis, recommendations, output_dir, data_hash, analysis_type, category, budget, system_data)
